<template>
	...
	>
		<div slot="drawerContent">
			...
			>
				<el-row type="flex" justify="start" align="top">
					<el-col :span="24">
						...
						<el-form-item label="未上线天数：" prop="noOnlineDay">
							<el-input
								v-model="formInfo.noOnlineDay"
								placeholder="请输入未上线天数"
								clearable
								:maxlength="20"
							/>
						</el-form-item>
			...
			<import-dialog
				ref="importDialog"
				action="api/monitor/onlineCarNum/importCarInfo"
...
import { addHandle } from "@/api/carMonitorSys/offlineReporting";
		...
		return {
				...
				noOnlineDay: [
          {
            ...
            formObjName: "formInfo",
				...
				car: [
					{ required: true, trigger: "blur", validator: validatecar },
					{ trigger: "change", validator: validatecar },
				],
			},
		};
	},
	...
	methods: {
		...
		submitForm() {
			const formCheckLeft = this.checkForm({
				formName: "formLeft",
				formList: ["taskName", "noOnlineDay", "car"],
			});
			if (!formCheckLeft) {
				return;
			}
