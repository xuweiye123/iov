        ...
        <div class="section-wrap">
          ...
          >
            <template slot="tableContent" slot-scope="scope">
              ...
              >
                <el-tag class="tagPointer" type="danger" effect="dark" style="width: 65px;">
              ...
              <span
                ...
                @click="errMsg(scope.row)"
              >
                <el-tag  class="tagPointer"  type="success" effect="dark" style="width: 65px;">
                  {{ scope.row[scope.item.prop] | switchText(scope.item.prop) }}
                </el-tag></span
              >
...
// request
import { getUploadTasks } from "@/api/carManageSys/commont";
import errMsgDialog from "./errMsgDialog";
export default {
