<template>
  <div class="js-system-user app-container">
    ...
    <!--导入-->
    <import-dialog
      action="api/battery/changeput/import"
      :template-url="
        'api/battery/fileStatics/ImportVehicleBatteryReplacementInformationBatch.xlsx'
      "
    ...
    <!-- 导入查询 -->
    <import-dialog
      :action="'/api/battery/changeput/importCode'"
      :title="'导入查询'"
      :template-url="'api/battery/fileStatics/ChangePutCodeImport.xlsx'"
...
import {
  ...
  exportCheck,
  exportByCode,
} from "@/api/batterySys/changeRepair";
...
export default {
  ...
  methods: {
    ...
    listLoad() {
      ...
      getchangeputList(this.listQuery)
        .then(({ data }) => {
          this.list = [];
          this.total = 0;
          if (data.code === 0) {
    ...
    handleExport() {
      ...
      exportchangeput(this.listQuery)
        .then(() => {
